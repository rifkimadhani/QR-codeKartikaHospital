                ...
                <?php foreach ($Datapasien as $row) : ?>
                    <tr class = "text-left" style="font-size: 13px;">
                        ...
                        <td>
                            ...
                            <a href=""><span><i class="bx bxs-pencil mx-1" style="color: #52525c;font-size : 18px;"></i></span></a>
                            <a href=""><span><i class="bx bxs-trash" style="color: #52525c;font-size : 18px;"></i></span></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
